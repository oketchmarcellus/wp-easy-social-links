    ...
    <Flex direction="column" align="stretch" gap={ 4 } style={{ width: '100%', maxWidth: '100%' }} style={ { borderBottom: '1px solid #f0f0f0', paddingBottom: '16px', marginBottom: '8px'} }>
      ...
      <FlexItem>
        <Text as="p" style={{ margin: 0, fontStyle: 'italic', fontSize: '14px', color: '#50575e' }}>
          { __( 'This is a simple plugin to help you quickly add your company social media icons and links to your WordPress site.', 'express-social-links' ) }
        </Text>
      </FlexItem>
      ...
      <FlexItem>
        <Text as="p" style={{ margin: 0, fontStyle: 'italic', fontSize: '14px', color: '#50575e' }}>
          { __( 'Add widget to your site by dragging it from the Gutenberg Widgets panel and dropping it where you want it to appear on the page.', 'express-social-links ' ) }
        </Text>
      </FlexItem>
        ...
        <Flex direction="row" align="start" gap={ 20 } justify='flex-start'>
          <FlexItem>
            <ExternalLink href="https://yourcompany.com">
              { __( 'Visit our Help Center', 'express-social-links' ) }
            </ExternalLink>
          </FlexItem>

          <FlexItem>
            <ExternalLink href="https://profiles.wordpress.org/marcellus89/">
              { __( 'View developer profile on WordPress.org', 'express-social-links' ) }
            </ExternalLink>
          </FlexItem>
        </Flex>
      </FlexItem>
